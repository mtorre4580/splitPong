...
//	//keys del server mio
	private final String apiKey = "980f9b7715be8824e1b3e04edac3bab3ccfed88a624219e3ef55c9c01b76ceff";
	private final String secretKey = "a3e5e1af60ee8146f2d784e5df13f6075a1ddfe5c340f71b3d413494039f7803";
	
	//keys del superjumper original
...
//	private final String secretKey = "55216a9a165b08d93f9390435c9be4739888d971a17170591979e5837f618059";
	...
	public void onDisconnectDone(boolean status){
		System.out.println("Disconnect from the room");
	}
...
//		log("onMoveUpdateReceived: message"+ message );
	...
	public void onUserWin(){
		warpListener.onGameFinished(GAME_WIN, true);
	}
	
	public void onUserLose(){
		warpListener.onGameFinished(GAME_LOOSE, true);
	}
	
	/**
	 * funcion que se ejecuta cuando un player se va de la partida
	 * @param roomId
	 * @param userName
	 */
